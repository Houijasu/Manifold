...
#
# Replays each UCI session from crates/mf-uci/tests/bench_cli.rs verbatim and prints the
# "Nodes searched:" vector it produces. Far cheaper than a debug bench_cli run. This is
# MSN-S1-qchecks/collect_anchors.ps1 brought back in sync with the test file: the
# post-LMR-without-LMR, both-LMR-features-off, post-LMR conthist, post-LMR depth,
# capture-LMR, futility/SEE-off and tunable-wiring sessions were missing from it.
...
Session 'contHist off (WITHOUT_CONTINUATION)' "setoption name UseCorrHistory value false`nsetoption name UseContHistory value false`nbench`nquit`n"
Session 'corrHist off (WITHOUT_CORRECTION)'   "setoption name UseCorrHistory value false`nbench`nquit`n"
...
Session 'capture LMR (2)'     "bench`nsetoption name UseCaptureLMR value false`nbench`nquit`n"
Session 'post-LMR depth (2)'  "bench`nsetoption name UsePostLMRDepth value false`nbench`nquit`n"
Session 'post-LMR conthist (2)' "bench`nsetoption name UsePostLMRContHist value true`nbench`nquit`n"

Session 'both LMR features off (WITHOUT_EITHER)' @"
...
Session 'post-LMR without LMR (3)' @"
setoption name UseLMR value false
bench
setoption name UsePostLMRDepth value false
bench
...
Session 'time effort (2)' "bench`nsetoption name UseTimeEffort value false`nbench`nquit`n"
