...
quit
"@
Session 'post LMR under UseLMR=false (3)' @"
setoption name UseLMR value false
bench
setoption name UsePostLMRDepth value false
bench
...
quit
"@
Session 'time effort (3)' "bench`nsetoption name UseTimeEffort value true`nbench`nsetoption name UseTimeEffort value false`nbench`nquit`n"
